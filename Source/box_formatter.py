...
g = open('../Data/Films/WikiBio_Styled_Formatted_Data/train/train.id', 'r')
...
train_box = open('../Data/Films/WikiBio_Styled_Formatted_Data/train/train.box', 'w+')
